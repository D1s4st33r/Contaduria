...
?>
    ...
    <main role="main" class="container">
     ...
     <?php
     $this->load->view('Panel_user/components_user/perfilVista');
     ?>
      <div class="my-3 p-3 bg-white rounded box-shadow">
        ...
        <div class="media text-muted pt-3">
          ...
          <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <div class="d-flex justify-content-between align-items-center w-100">
              <strong class="text-gray-dark">Empresa 1</strong>
              <a href="#">Follow</a>
            </div>
        ...
        <div class="media text-muted pt-3">
          ...
          <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <div class="d-flex justify-content-between align-items-center w-100">
              <strong class="text-gray-dark">Empresa 2</strong>
              <a href="#">Follow</a>
            </div>
            <span class="d-block">RFC EJEMPLO</span>
          </div>
        ...
        <div class="media text-muted pt-3">
          ...
          <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
            <div class="d-flex justify-content-between align-items-center w-100">
              <strong class="text-gray-dark">Empresa 3</strong>
              <a href="#">Follow</a>
            </div>
            <span class="d-block">RFC EJEMPLO</span>
          </div>

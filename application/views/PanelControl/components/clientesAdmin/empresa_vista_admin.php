  ...
  <div class="col-sm-12 col-md-12 col-lg-2 py-1">
    <div class="container p-0">
      <div class="row p-0">
        ...
        <div class="col-sm-6 col-md-6 col-lg-12 p-1">
          <button type="button" class="btn btn-outline-danger btn-block " onclick=" return hacerCambio('<?php echo $empresa['rfc'] ; ?>','<?php echo base_url('EliminarEmpresa').$session.'&rfc='.$empresa['rfc']; ?>')"> <i class='fas fa-trash-alt'></i>  </button> 
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row ">
        <div class="col-md-6 col-sm-12 text-left pt-2">
          <a href="#contadorEmpresa<?php echo $empresa['rfc'];?>" 
              class="small  pr-2 " 
              onclick="hacerCambio('contadorEmpresa<?php echo $empresa['rfc'];?>',
                      '<?php echo base_url('verListaContadoresAsignados').$session.'&rfc='.$empresa['rfc'];?>')
                      ;">
              <label class="pl-2 text-muted small m-0"> Contadores Asignados</label>
